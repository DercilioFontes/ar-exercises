...
@store1.employees.create(first_name: "Carlos", last_name: "Silva", hourly_rate: 70)
...
@store2.employees.create(first_name: "Vânia", last_name: "Tavares", hourly_rate: 100)
@store2.employees.create(first_name: "Eduardo", last_name: "Fonseca", hourly_rate: 90)
